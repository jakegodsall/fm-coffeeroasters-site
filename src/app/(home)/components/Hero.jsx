...
export default function Hero() {
  return (
    <section className="sm:bg-home-hero-tablet relative w-full overflow-hidden rounded-[1rem] bg-home-hero-mobile bg-center bg-no-repeat sm:bg-cover lg:bg-home-hero-desktop">
